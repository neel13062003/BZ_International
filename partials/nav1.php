...
echo ' <header style="background-color:black;">
                ...
                <a class="navbar-brand" href="index" style="color:white; margin:5px;padding:5px;"><h3>MLM - BZ International</h3></a>
                ...
                <div>
                    <ul class="navbar-nav">
                        <li class="nav-item active">
                            <a class="nav-link" href="index"><h4>Earn Money From Your investment</h4></a>
                        </li>
                        </ul>
                </div>';
